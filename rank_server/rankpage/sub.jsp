...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div
				...
				<h1 class="h2">기간별 순위 차트</h1>
				<div class="btn-toolbar mb-2 mb-md-0">
					<div class="btn-group mr-2">
						<button type="button" class="btn btn-sm btn-outline-secondary" onclick="chartupdate()">Update</button>
						<button type="button" class="btn btn-sm btn-outline-secondary"
							onclick="location.href='/RankServlet?key=doexcel_sub'">Export</button>
					</div>
					<button type="button"
						...
						<c:forEach var="i" items="${rank }">
							<tr>
								...
								<td><a class="shop_link"
									href="${i.product_link}" target="_blank">${i.title }</a></td>
								<td>${i.review }</td>
								<td>${i.purchase }</td>
								<td>${i.zzim }</td>
								<td>${i.regist_date }</td>
								...
								<td><a onclick="deleteCheck('${i.idx}')">삭제하기</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
	...
	<script src="/rank/resource/dashboard.js"></script>
</body>
</html>
